        ...
        >
                    ...
                    <View>
                        ...
                        >
                            <View style={styles.flexRow}>
                                ...
                                />
                                <GlobalText
                                    text={`${data.distance?.toFixed(2)} ${t(
                                        "KM"
                                    )}`}
                                />
                            </View>
                            <View style={[styles.flexRow]}>
                                ...
                                />
                                <GlobalText
                                    text={`${data.route_stops.length} ${t(
                                        "STOPS"
                                    )}`}
                                />
                            </View>
            ...
            <View
                style={[
                    ...
                    {
                        backgroundColor: JSON.parse(data.bus_type.meta_data)[0]
                            .color_code,
                    },
                ]}
            >
                <GlobalText
                    text={data.bus_type.type}
